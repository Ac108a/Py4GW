...
class PyQuishAiOverwatch:
    """
    Overwatch monitor for PyQuishAi.
    ...
    def __init__(self, fsm_runner):
        """
        fsm_runner: instance of PyQuishAiFSM
        """
    ...
    def _loop(self):
        ...
        def _generator():
            ...
            while True:
               ...
               #     ConsoleLog("Overwatch", f"Overwatch: Party Defeated - resetting run.", Console.MessageType.Warning)
